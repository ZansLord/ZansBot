...
sendEphemeral: false,
"externalAdReply": {
                "title": `Whatsapp-BOT\n𝗭𝗮𝗻𝘀 𝗕𝗼𝘁. (@nnda.krnwn_) •Instagram photos and Videos`,
                "body": "",
                "previewType": "PHOTO",
...
"externalAdReply": {
                "title": `Whatsapp`,
                "body": `wa.me/6285869074622`,
                "mediaType": "10",
                "mediaUrl": `wa.me/6285869074622`,
                "thumbnailUrl": "https://i.ibb.co/y0RYgzB/FB-IMG-1635413002830.jpg",
                "thumbnail": iye,
                "sourceUrl": `wa.me/6285869074622`,
...
*Thank you for registering in the 𝗭𝗮𝗻𝘀 𝗕𝗼𝘁 Database*
...
groups = Sibu.chats.array.filter(v => v.jid.endsWith('g.us'))
              ...
              total = math(`${groups.length}*${privat.length}`)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
        ptod = "6285869074622@s.whatsapp.net"
        dtod = '6285869074622'
        stod = `${sender}`
        uwuu = '```'
        yoii = '*'
...
𝗡𝗼𝘁𝗲 : Horny = Bonks💥
           Sange = Pukul Orang Sangen🗿
Baru Mempelajari Cara Membuat Bot 😎
...
case 'bugreport':
              ...
              Sibu.sendMessage('6285869074622@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
...
㋛${prefix}𝙩𝙬𝙞𝙩𝙩𝙚𝙧 <𝙪𝙧𝙡>
`
sendButMessage(from, menu, `𝗭𝗮𝗻𝘀 𝗕𝗼𝘁`, [
          {
            buttonId: `command`,
            buttonText: {
...
case 'script':
		case 'sc':
		case 'sourcecode':
		Sibu.sendMessage(from, { text: "https://github.com/ZansLord/ZansBot", matchedText: 'nopee', description: "", title: "What are you doing?", jpegThumbnail: iye }, 'extendedTextMessage', { detectLinks: false, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
      //------------------< Sticker Cmd >-------------------
      case "addcmd":
      case "setcmd":
     ...
     break
        ...
        case "broadcast":  
                   if (!isOwner && !mek.key.fromMe) return reply('only owner can use this feature')    
					...
					buff = await Sibu.downloadMediaMessage(encmedia)
					for (let _ of anu) {
						Sibu.sendMessage(_.jid, buff, image, {quoted:fakestatus ,caption: `「  *𝗭𝗮𝗻𝘀 𝗕𝗼𝘁 BROADCAST* 」\n\n${ini_bc}`})
					}
					reply('```Success Broadcast```')
					} else {
					for (let _ of anu) {
					Sibu.sendMessage(_.jid, `*𝗭𝗮𝗻𝘀 𝗕𝗼𝘁 BROADCAST*\n${ini_bc}`, text, { contextInfo: { mentionedJid: [sender],"forwardingScore":999,"isForwarded":true},sendEphemeral: true })
					}
					reply('```Success Broadcast```')
					}
					break
...
buttons = [{buttonId: `writelist`,buttonText:{displayText: `Write List🔖`},type:1}]
              ...
              buttonsMessage = {footerText:'𝗭𝗮𝗻𝘀 𝗕𝗼𝘁', imageMessage: imageMsg,
...
sendButMessage(from, tiyo, `𝗭𝗮𝗻𝘀 𝗕𝗼𝘁`, [
            {              
   ...
   case 'bc':
      case 'broadcast':
        if (!mek.key.fromMe) return;
             ...
             for (let _ of anu) {
             Sibu.sendMessage(_.jid, bc, image, {quoted:fkontak,caption: `*「 𝗭𝗮𝗻𝘀 𝗕𝗼𝘁 BROADCASTING 」*\n\n${body.slice(4)}`})
}
